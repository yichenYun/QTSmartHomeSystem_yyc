    ...
    ui(new Ui::Myweather)
{
    ...
    connect(http,&QNetworkAccessManager::finished,this,&Myweather::slot_reply);//处理接收数据
    connect(ui->pushButton_find,&QPushButton::clicked,this,&Myweather::slot_request);//请求数据
    slot_request();//初始化界面
